...
# and is always a number between 0.0 and 0.5, where 0.0 would mean all of the samples got the same result,
...
# Nationality
# Nationality <= 0.5 means that the comedians with a nationality value of less than 0.5 will follow the arrow to the left
# (which means everyone from the UK, ), and the rest will follow the arrow to the right.
...
# Age
# Age <= 35.5 means that comedians at the age of 35.5 or younger will follow the arrow to the left,
...
# Experience
# Experience <= 9.5 means that comedians with 9.5 years of experience, or less, will follow the arrow to the left,
# and the rest will follow the arrow to the right.
